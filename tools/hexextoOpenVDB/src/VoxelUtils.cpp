...
// // return vertex positions in pixel space.  
        ...
        Eigen::Matrix3d jacobian_normalized = jacobian * ( 1. / jac_max );
        jac0 = jac0 / jac_max;
        jac1 = jac1 / jac_max;
        jac2 = jac2 / jac_max;
...
void stampParamView_old(SceneInfo sc)
{
    double BIG_NUM = 100000000000000000.0;
...
// // return vertex positions in pixel space.  
        ...
        double det = ((B-A).normalized()).cross((C-A).normalized()).dot((D-A).normalized());
